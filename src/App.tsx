...
const menusItems = ['Why', 'How', 'Get Involved', 'FAQ', 'Testimonials', 'Community Support'];
            ...
            >
                {menusItems.map((item) => (
                    <div key={item}>
                        ...
                        <div style={{ height: '15vh' }} ref={sections[item.replace(/ /g, '') as keyof typeof sections]}></div>
                        <div
                            style={{
