    ...
    return (
        <>
            ...
            <div id="container" className="absolute inset-0 overflow-auto">
                <header
                    className="sticky top-0 z-50 h-fit py-4 px-8 backdrop-blur-sm bg-white/5 flex justify-between items-center shadow-sm">
                    <Link to={"/"}>
                ...
                <main className="max-w-screen-xl mx-auto p-6">
                    <div className="w-full flex flex-col items-center justify-center h-dvh -mt-[88px]">
                        <div className="w-full flex flex-col md:flex-row justify-between items-center">
                            ...
                            <div
                                className="h-fit max-w-[500px] w-full mt-10 md:mt-0 flex flex-col gap-4 items-center justify-center p-6 bg-gray-300/10 backdrop-blur-sm rounded-lg shadow-sm font-bold text-gray-100">
